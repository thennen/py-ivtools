...
SavePlace='E:\\transfer\\CC\\Felix\\FC_1_32_100nm_1um_Y01_D11\\SimpleIV_and_analyze_test\\'
import datetime
try:
    os.mkdir(SavePlace)
...
endcycle=None
stepcycle=1
print('Beginning advanced analysis')
SavePlace_functions=SavePlace+filename
pd.options.mode.chained_assignment = None  # default='warn'
v0=0.3
    
    
analysis_results = get_parameters(data, v0=v0, polarity = False)
#analysis_results.to_excel(SavePlace_functions+'analysis_results.xlsx')
#plot_LRS_HRS_fit(data=data, SavePlace=SavePlace_functions, startcycle=startcycle,endcycle=endcycle,stepcycle=stepcycle)
#plot_LRS_HRS_pos(data=data, SavePlace=SavePlace_functions, startcycle=startcycle,endcycle=endcycle,stepcycle=stepcycle)
#plot_LRS_HRS_neg(data=data, SavePlace=SavePlace_functions, startcycle=startcycle,endcycle=endcycle,stepcycle=stepcycle)
#plot_V_SET_V_RESET(data=data, SavePlace=SavePlace_functions, startcycle=startcycle,endcycle=endcycle,stepcycle=stepcycle)
#    
